To run this program on your local machine, you can clone this repo and change .ipynb file to a .py file if you do not want to run it on a Jupyter notebook
